  ...
  methods:{
    login(){
      let json ={
       ...
       if (json.usuario=="dato1@quick.com" && json.password=="123456") {
        localStorage.token= json.usuario;
        this.$router.push('dashboard');
       }else if(json.usuario=="dato2@quick.com" && json.password=="654321"){
        localStorage.token= json.usuario;
        this.$router.push('maintenance');
       }else{
         this.error = true;
         this.error_msg = "Usuario y/o Contraseña incorrecto"
       }
    }
