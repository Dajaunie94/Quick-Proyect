        ...
        <div class="col-md-6">
            <div class="error-template">
                <h1>
                    :) Oops!</h1>
                <h2>
                    Temporalmente fuera de servicio</h2>
                <h1>
                    Vuelve pronto !</h1>
                <div>
                    <p>
                        lamentamos los inconvenientes presentados estamos trabajando para darte una mejor experencia !</p>
                    <p>
                        — El equipo</p>
                </div>
                <div class="error-actions">
                  <form v-on:submit.prevent="inicio">                              
                    <input type="submit" class="btn btn-info btn-lg" value="Vuelve al inicio">  
